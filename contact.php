...
<head>
	...
	<title>Bwire Jobs - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Tanzania, United Republic of<br/>PO.BOX 14859, <br/>Dar es Salaam </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:mashauri@programmer.net">mashauri@programmer.net</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+255 689 938 643">+255 689 938 643</a>
								</li>
